...
const { authorizeRole, authorizeRoleAdmin } = require("../../Middlewares/authorizeMiddleware")
...
router.get("/admin", authMiddleware, authorizeRoleAdmin('admin', 'moderator'), getAdmin)
