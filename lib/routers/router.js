...
router.get("/dashboard/code/reward", authMiddleware, ensureAuthenticated, GetRewardCode)
...
// ==================================================== Route Admin Page ========================================
// ==============================================================================================================
const { getAdmin, getAdminReward, getAdminAPIKEY, ManageAnimes, getAdminRewardManage, ManageActor, ManageActPIKey, ManageVideos, filterUsers } = require("../../Controllers/AdminController")
