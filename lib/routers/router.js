...
const { getDashboard, getMonetization, getDashboardManageArticle, getNotifications, getNotificationisRead, Getedit, GetRewardCode, gatPlaymentEdit, deletePostArticle } = require("../../Controllers/DashboardController")
...
const { getCountdown } = require("../../Controllers/CountdownController")
const { getRandomAnimeLists, getRandomAnimeWinter } = require("../../Controllers/RandomController")
...
// ================================================== Route AI  and Countdown ================================================
// ==============================================================================================================
router.get("/ai/vtuber", ensureAuthenticated, getAiVtuber)
router.get("/Countdown/happy-new-year", getCountdown)
...
router.get("/monetization", authMiddleware, getMonetization)
...
// ==================================================== Route Admin Page ========================================
// ==============================================================================================================
const { getAdmin, getAdminManageUser, getAdminEditUser, getAdminReward, getAdminAPIKEY, getAdminAddBanner, gatManagePlayment, ManageBanner, ManageAnimes, getAdminRewardManage, ManageActor, ManageActPIKey, ManageVideos, getListseriesEP, filterUsers } = require("../../Controllers/AdminController")
...
router.get("/admin/edit/user/:userId", authMiddleware, authhorizeRoleAdmin('admin', 'moderator'), getAdminEditUser)
...
// ================================================== Route Random Anime ================================================
// ==============================================================================================================
router.get("/random/anime/lists", getRandomAnimeLists)
router.get("/random/anime/list/winter/:year", getRandomAnimeWinter)
