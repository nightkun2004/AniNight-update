...
const { getDashboard, getDashboardManageArticle, getNotifications, getNotificationisRead, Getedit, GetRewardCode, gatManagePlayment, gatPlaymentEdit, deletePostArticle } = require("../../Controllers/DashboardController")
...
const { getAnimeInfo, getAnimeScheduleTimeline, getFilterAnime, getAnimeStream } = require("../../Controllers/ScheduleAnimeController")
...
// ==================================================== Route Admin Page ========================================
// ==============================================================================================================
const { getAdmin, getAdminManageUser, getAdminReward, getAdminAPIKEY, getAdminAddBanner, ManageBanner, ManageAnimes, getAdminRewardManage, ManageActor, ManageActPIKey, ManageVideos, filterUsers } = require("../../Controllers/AdminController")
...
router.get("/admin/mamage/rewards", authMiddleware, authhorizeRoleAdmin('admin', 'moderator'), getAdminRewardManage)
router.get("/admin/mamage/banner", authMiddleware, authhorizeRoleAdmin('admin', 'moderator'), ManageBanner)
...
router.get("/admin/add/anime/schedule/time", authMiddleware, authhorizeRoleAdmin('admin', 'moderator'), getAddAnimeScheduleTimeline)
