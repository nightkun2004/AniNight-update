...
const { getAnime, getCharacters, getPVAnime, getEditAnime, getSchedule, getInfiniteScroll, getAnimeStreem } = require("../../Controllers/AnimeController")
...
// ==================================================== Route Admin Page ========================================
// ==============================================================================================================
const { getAdmin, getAdminAPIKEY, ManageAnimes, ManageVideos, filterUsers } = require("../../Controllers/AdminController")
