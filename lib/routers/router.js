...
const { getAnime, getCharacters, getPVAnime, getEditAnime, getAddActorToCharacter, getSchedule, getInfiniteScroll, getAnimeStreem, getAnimeStreemYoutube } = require("../../Controllers/AnimeController") 
...
// ==================================================== Route Admin Page ========================================
// ==============================================================================================================
const { getAdmin, getAdminAPIKEY, ManageAnimes, ManageActor, ManageVideos, filterUsers } = require("../../Controllers/AdminController")
...
router.get("/uploads/create/article", ensureAuthenticated, authorizeRole('user', 'content_creator', 'partners'), (req, res) => {
    const userID = req.session.userlogin;
    const lang = res.locals.lang;
